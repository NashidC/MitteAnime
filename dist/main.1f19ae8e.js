...
(() => {
  window.addEventListener("load", () => {
    ...
    topButton.addEventListener("click", async () => {
      let apiData = await (0, _api.default)();
      console.log(apiData);
...
(() => {
  window.addEventListener("load", () => {
    ...
    newsButton.addEventListener("click", async () => {
      let newsInfo = await (0, _news.default)();
      ...
      remove.remove(); // Line above removes background image on News
...
},{"./api":"api.js","./news":"news.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
